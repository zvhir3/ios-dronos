...
/**
 *  Updated signal quality in percent for the base station (from remote controller
 *  to the base station). This  link transfers all information between the remote
 *  controller and the base station, which is predominantly  positioning
 *  information.
 *  
 *  @param airLink The air link from remote controller to aircraft.
 *  @param quality The signal quality in percent with range [0, 100], where 100 is the best quality.
 */
- (void)airLink:(DJIAirLink *)airLink didUpdateBaseStationSignalQuality:(NSUInteger)quality;
