...
/**
 *  The current flat mode of the camera. This is available only when
...
/**
 *  `YES` If the camera is in playback mode. This is available only when
 *  `isFlatCameraModeSupported` returns `YES`.
 */
...
/**
 *  The progress of the executing hyperanalytic shot. It is `nil` if there is no
 *  executing hyperanalytic shot.
 */
