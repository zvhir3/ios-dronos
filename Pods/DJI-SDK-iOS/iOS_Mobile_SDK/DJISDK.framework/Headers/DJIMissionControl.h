...
/**
 *  Sets the time you want to delay before element execution which is used for
 *  asynchronous processing scenarios. For example, if you want to execute
 *  `DJIGimbalAttitudeAction` after `DJIShootPhotoAction`, you should set delay time
 *  in `DJIGimbalAttitudeAction`. Because it takes 1 to 2 seconds to take a photo,
 *  the gimbal's commands will not be responded during this period,  so we need to
 *  delay 2 seconds before turning the gimbal to ensure that the gimbal movement is
 *  executed correctly.
 *  
 *  @param delayTime The time you want to delay before element execution, unit:second.
 */
@required
 ...
 *  
 *  @return An Intelligent Hotpoint mission operator object.
 */
 ...
 *  
 *  @return An waypoint v2 mission operator object.
 */
