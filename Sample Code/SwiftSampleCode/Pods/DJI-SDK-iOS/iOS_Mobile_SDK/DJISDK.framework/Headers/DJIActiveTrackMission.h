...
typedef NS_ENUM (NSInteger, DJIActiveTrackMode) {
     ...
     *  constant distance with the subject. Not Supported by Mavic Air 2, DJI Air 2S.
     */
	 ...
	 *  `DJIActiveTrackQuickShotMode`) while tracking the object recording a video. When
	 *  a QuickShot mission ends, a 10-second video will be generated. Supported by
	 *  Spark and Mavic 2 Series.
	 */
	DJIActiveTrackModeQuickShot,
    

    /**
     *  Aircraft will circle around the object it is tracking. Only Supported by Mavic
     *  Air 2 and Mavic 2 Series.
     */
    DJIActiveTrackModeCircle,
...
typedef NS_ENUM(NSUInteger, DJIActiveTrackQuickShotMode) {
     ...
     *  the video finishing at the start point. Supported by DJI Mavic Air, Mavic 2 Zoom
     *  and Mavic 2 Pro.
     */
     ...
     *  panorama into a short video. Supported by DJI Mavic Air, Mavic 2 Zoom and Mavic
     *  2 Pro.
     */
...
/**
 *  Index of the auto-sensed subjects. After enabling auto sensing, the aircraft may
 *  find multiple subjects and an index will be assigned to each subject. Use this
 *  index to select the subject to track.
 */
 ...
 *  subject. The rectangle is normalized to [0,1] where (0,0) is the top left of the
 ...
 *  tracked. The rectangle is normalized to [0,1] where (0,0) is the top left of the
 *  video preview and (1,1) is the bottom right.
 *  
 *  @return .
 */
...
/**
 *  Reason why the target cannot be confirmed by the user. It is useful when `state`
 *  is `DJIActiveTrackTargetStateCannotConfirm`.  Otherwise, it is
 *  `DJIActiveTrackCannotConfirmReasonNone`. Not supported by Mavic Air 2, DJI Air
 *  2S.
 */
