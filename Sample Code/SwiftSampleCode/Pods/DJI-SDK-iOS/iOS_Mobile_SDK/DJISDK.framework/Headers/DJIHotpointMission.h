 ...
 *  by Mavic Pro when using WiFi connection. It is not supported by Spark, Mavic
 *  Mini, Mavic Air 2, DJI Air 2S and Matrice 300 RTK.
 */
 ...
 *  
 *  @return Error found when checking parameters of the hotpoint. `nil` if all the parameters are valid.
 */
...
/**
 *  Set aircraft's initial point on the circular flight path when starting the
 *  hotpoint  mission.
 */
...
/**
 *  Aircraft's heading while flying around the hotpoint. It can be pointed toward or
 *  away from the hotpoint, forward or backward along its flight route, or can be
 *  manually controlled by the remote controller.
 */
@property(nonatomic, assign) DJIHotpointHeading heading;


/**
 *  Sets the altitude of the hotpoint orbit with a range [5,500] meters.  The
