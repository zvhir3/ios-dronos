...
/**
 *  The connected base station instance. It is supported by Phantom 4 RTK and
 *  Matrice 210 RTK V2.
 */
...
/**
 *  Retrieves instances of the product's Lidars.
 */
@property (nonatomic, readonly) NSArray<DJILidar *> *_Nullable lidars;
