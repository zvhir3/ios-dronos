...
/*********************************************************************************/
#pragma mark DJIFlyZoneReturnToHomeState
/*********************************************************************************/


/**
 *  This enum describes whether the aircraft's route when returning to home is clear
 *  of, near, or passes through a fly zone.
 */
typedef NS_ENUM (NSUInteger, DJIFlyZoneReturnToHomeState){
    

    /**
     *  The aircraft's return to home route is clear of restricted areas.
     */
    DJIFlyZoneReturnToHomeStateClear = 0,
    

    /**
     *  The aircraft's return to home route is near an authorization or restricted zone.
     */
    DJIFlyZoneReturnToHomeStateNearNoFlyZone = 1,
    

    /**
     *  The aircraft's return to home route passes through an authorization or
     *  restricted zone.
     */
    DJIFlyZoneReturnToHomeStateCrossNoFlyZone = 3,
    

    /**
     *  Unknown.
     */
    DJIFlyZoneReturnToHomeStateUnknown = 0xFF,
};
