...
/**
 *  The class provides information of the latest interrupted waypoint mission.
 */
@interface DJIWaypointMissionInterruption : NSObject
...
/**
 *  The aircraft's altitude when the mission is interrupted. This value represents
 *  the  absolute height. If use this to create a new waypoint, you need to  use
 *  `takeoffLocationAltitude`  to calculate the relative height.
 */
 ...
 *  supported by Spark, Mavic Mini, DJI Mini 2, DJI Mini SE, Mavic Air 2, DJI Air 2S
 *  and Matrice 300 RTK.
 */
...
/**
 *  Mission execution can be repeated more than once. The value range is [1, 255].
 *  If 255 is selected,  then the mission will continue to be executed until
 *  `stopMissionWithCompletion` is  called or any error occurs. Other values
 *  represent the exact execution times of the mission.
 */
