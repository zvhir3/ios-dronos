...
/**
 *  Called when the latest fly safe notification is received.
 *  
 *  @param manager The fly zone manager that updates state.
 *  @param notification An object value of `DJIFlySafeNotification`.
 */
-(void)flyZoneManager:(DJIFlyZoneManager *)manager didUpdateFlyZoneNotification:(DJIFlySafeNotification *)notification;
 ...
 *  Not supported by DJI Air 2S.</br>
 */
...
/**
 *  Deletes all unlocking licenses in the aircraft. Supported only by Mavic Mini,
 *  DJI Mini 2, DJI Mini SE and Matrice 300 RTK.
 *  
 *  @param completion Completion block to receive the result.
 */
- (void)deleteAllUnlockingLicenses:(void(^)(NSError *))completion;
