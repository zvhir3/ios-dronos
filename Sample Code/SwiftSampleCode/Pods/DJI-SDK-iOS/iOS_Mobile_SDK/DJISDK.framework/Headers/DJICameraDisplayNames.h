...
/**
 *  The display name for Zenmuse L1. Note: Zenmuse L1 can only be set at Gimbal
 *  position 0 where it is at the left side of the aircraft.
 */
extern NSString *const DJICameraDisplayNameZenmuseL1;


/**
 *  The display name for Zenmuse P1. Note: Zenmuse P1 can only be set at Gimbal
 *  position 0 where it is at the left side of the aircraft.
 */
