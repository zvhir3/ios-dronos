 ...
 *  will be cached to `isUserActivated`. Please invoke the
 *  `authorizeAccessToDJIDeviceHardwareInfo` to authorize DJI server to access DJI
 *  device's hardware information.
 *  
