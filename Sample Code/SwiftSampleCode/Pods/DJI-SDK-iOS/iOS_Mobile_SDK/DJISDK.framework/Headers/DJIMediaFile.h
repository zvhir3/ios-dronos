...
/*********************************************************************************/
#pragma mark - DJIMediaVideoFileType
/*********************************************************************************/


/**
 *  Video file types. It is not supported by `camera:didGenerateNewMediaFile` return
 *  `DJIMediaFile` media file object.
 */
typedef NS_ENUM (NSUInteger, DJIMediaVideoFileType){
	

	/**
	 *  The video file is recorded in normal mode.
	 */
	DJIMediaVideoFileTypeNormal,
	

	/**
	 *  The video file is recorded in time-lapse mode.
	 */
	DJIMediaVideoFileTypeTimeLapse,
	

	/**
	 *  The video file is recorded as slow motion video.
	 */
	DJIMediaVideoFileTypeSlowMotion,
	

	/**
	 *  The video file is recorded during a QuickShot mission.  Use
	 *  `DJIActiveTrackModeQuickShot`  to check the detail QuickShot mode of the video
	 *  file.
	 */
	DJIMediaVideoFileTypeQuickShot,
	

	/**
	 *  The video is recorded when the aircraft is in hyper-lapse mode.  It is only
	 *  supported by Mavic 2 Zoom and Mavic 2 Pro. Hyper-lapse  is only supported by DJI
	 *  GO 4.
	 */
	DJIMediaVideoFileTypeHyperlapse,
	

	/**
	 *  Unknown.
	 */
	DJIMediaVideoFileTypeUnknown = 0xFF,
};

/*********************************************************************************/
#pragma mark -  DJIMediaQuickShotVideoType
/*********************************************************************************/


/**
 *  The QuickShot modes of the video file when its type is
 *  `DJIMediaVideoFileTypeQuickShot`.
 */
typedef NS_ENUM (NSUInteger, DJIMediaQuickShotVideoType){
	...
	/**
	 *  The video file is not a QuickShot video.
	 */
	DJIMediaQuickShotVideoTypeNone,
	

	/**
	 *  The QuickShot video file is recorded in Circle mode.
	 */
	DJIMediaQuickShotVideoTypeCircle,
	

	/**
	 *  The QuickShot video file is recorded in Dronie mode.
	 */
	DJIMediaQuickShotVideoTypeDronie,
	

	/**
	 *  The QuickShot video file is recorded in Helix mode.
	 */
	DJIMediaQuickShotVideoTypeHelix,
	

	/**
	 *  The QuickShot video file is recorded in Rocket mode.
	 */
	DJIMediaQuickShotVideoTypeRocket,
	

	/**
	 *  The QuickShot video file is recorded in Boomerang mode.
	 */
	DJIMediaQuickShotVideoTypeBoomerang,
	

	/**
	 *  The QuickShot video file is recorded in Asteroid mode.
	 */
	DJIMediaQuickShotVideoTypeAsteroid,
	

	/**
	 *  The QuickShot video file is recorded in DollyZoom mode.
	 */
	DJIMediaQuickShotVideoTypeDollyZoom,
	

	/**
	 *  Unknown.
	 */
	DJIMediaQuickShotVideoTypeUnknown = 0xFF,
};
...
/**
 *  Returns the `DJICameraShootPhotoMode` of a photo. Returns `nil` if `mediaType`
 *  is
 *   `DJIMediaTypeMOV` or `DJIMediaTypeMP4`.
 */
@property(nonatomic, readonly) DJICameraShootPhotoMode shootPhotoMode;


/**
 *  Returns the `DJICameraPhotoPanoramaMode` of a photo. It is valid when
 *  `shootPhotoMode` is `DJICameraShootPhotoModePanorama`.
 */
 ...
 *  use `fetchCustomInformationWithCompletion` to populate it. Supported by Zenmuse
 *  P1, Zenmuse L1, Phantom 4 RTK, Phantom 4 Pro, Phantom 4 Advanced and Inspire 2
 *  with firmware versions from after May 23 2017.
 */
@property(nonatomic, nullable, readonly) NSString *customInformation;


/**
 *  This property contains the XMP data which was written to this media file. If
 *  this property returns `nil`, use `fetchXMPFileDataWithCompletion` to populate
 ...
 *  Phantom 4 Pro V2.0, Zenmuse P1, Zenmuse L1, Zenmuse X4S, Zenmuse X5S, Zenmuse X7
...
/**
 *  Fetch the XMP data stored in the media file. The data will be stored in
 *  `XMPInformation`. Only supported by Zenmuse P1, Zenmuse L1, Phantom 4 RTK.
 *  
 *  @param completion The `completion block` with the returned execution result.
 */
...
/**
 *  Fetches this media file's full resolution data from camera. The difference
...
/**
 *  Returns the index of media file. This is the only identifier of the media file.
 *  You can use this index to match the index obtained by the
 *  `sdCardFileListSnapshot` or `internalStoragefileListSnapshot`,   and then you
 *  can get more information about the new media file, such as the file name, etc.
 */
@property(nonatomic, readonly) NSUInteger index;
...
/**
 *  Returns the time when the media file was created as a long type, unit: second.
 *  You can convert the second to date and time format on your own.
 */
@property(nonatomic, readonly) NSString* timeCreated;
