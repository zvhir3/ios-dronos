...
/**
 *  Use this property to change which lens's settings are loaded into the panel.
 *  The default  value is 0 so you will only need to change this is working with an
 *  aircraft that supports multiple lenses.
 */
@property (assign, nonatomic, readwrite) NSUInteger preferredLensIndex;
