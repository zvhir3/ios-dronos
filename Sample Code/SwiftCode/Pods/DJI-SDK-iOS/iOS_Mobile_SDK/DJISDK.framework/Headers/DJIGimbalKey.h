...
EXTERN_KEY NSString *const DJIGimbalParamResetWithAxis;
...
EXTERN_KEY NSString *const DJIGimbalParamStartControlParametersAutoTuning;
EXTERN_KEY NSString *const DJIGimbalParamStopControlParametersAutoTuning;
EXTERN_KEY NSString *const DJIGimbalParamResetControlParameters;
EXTERN_KEY NSString *const DJIGimbalParamControlParametersAutoTuningState;

EXTERN_KEY NSString *const DJIGimbalParamStartBalanceDetection;
EXTERN_KEY NSString *const DJIGimbalParamStopBalanceDetection;
EXTERN_KEY NSString *const DJIGimbalParamBalanceDetectionState;

EXTERN_KEY NSString *const DJIGimbalParamStartCoaxialityDetection;
EXTERN_KEY NSString *const DJIGimbalParamStopCoaxialityDetection;
EXTERN_KEY NSString *const DJIGimbalParamCoaxialityDetectionState;
