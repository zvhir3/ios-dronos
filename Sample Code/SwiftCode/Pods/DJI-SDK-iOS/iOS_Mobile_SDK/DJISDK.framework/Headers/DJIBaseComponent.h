 ...
 *  to the battery on the port (left hand) side of the aircraft.  For M210, M210 RTK
 *  and M300 RTK, `DJICamera` and `DJIGimbal` with index 0 corresponds to the camera
 *  and gimbal on the port  (left hand) side of the aircraft. `DJILidar` with index
 *  0 corresponds to the lidar(Zenmuse L1) on the port  (left hand) side of the
 *  aircraft.
 */
