 ...
 *  finish. It is  only supported by `DJIAircraftModelNameMatrice300RTK`.
 */
@interface DJIWaypointV2Mission : DJIMission


/**
 *  Initialize a `DJIWaypointV2Mission` by copying the parameters from the input
 *  mission.
 *  
...
- (nullable NSError *)checkParameters DJI_API_DEPRECATED("This interface is no longer used.");
 ...
 *  previously uploaded mission). In these cases, `isComplete`  will return `YES`.
 */
 ...
 *  position. Default  is `DJIWaypointV2MissionGotoFirstWaypointModeSafely`.
 */
 ...
 *  
 *  @return The `DJIWaypointV2` at the specified index.
 */
 ...
 *  
 *  @return An array of `DJIWaypointV2` instances contained in the mission.
 */
 ...
 *  Default is `DJIWaypointV2MissionGotoFirstWaypointModeSafely`.
 */
 ...
 *  should be in the range [2, 65535]. When the waypoints are added successfully,
