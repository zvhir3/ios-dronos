...
/**
 *  Data Protection Manager. DJI SDK will send data to DJI servers in the background
 *  in order to complete logics, including data related to user's information. Data
 ...
 *  The UTMISSManager class needs to report flight dynamic data to the UTMISS server
 *  in accordance with the policy requirements of the Civil Aviation Administration
 *  of China. It is not in this category of management. For details, please refer to
 *  the UTMISSManager interface document.
 */
