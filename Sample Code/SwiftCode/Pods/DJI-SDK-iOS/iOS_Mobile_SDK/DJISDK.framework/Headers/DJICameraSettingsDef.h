...
#import "DJIVideoFeedBaseTypes.h"
...
/*********************************************************************************/
#pragma mark DJIFlatCameraMode
/*********************************************************************************/


/**
 *  Flat camera mode can be used to set the mode to camera directly. The benefit is
 *  no need to set the camera mode to shoot photo mode or the Record video first.
 *  Please use `setFlatMode:withCompletion` to set the flat mode. This is available
 *  only when `isFlatCameraModeSupported` returns `YES`.
 */
typedef NS_ENUM (NSUInteger, DJIFlatCameraMode){
     ...
     *  manually change any settings between frames.
     */
    ...
    /**
     *  Sets the camera to take a picture (or multiple pictures) continuously at a set
     *  time interval. The minimum interval for JPEG format of any quality is 2s.
     */
     ...
     *  environment to enhance the photo quality while reducing noise significantly.
     */
    DJIFlatCameraModePhotoHyperLight,
    

    /**
     *  Sets the camera to take photos in panorama mode. the aircraft takes a series of
     *  photos with different gimbal and aircraft heading positions. The photos can be
     *  stitched with a third-party library.
     */
     ...
     *  for ghost-free high dynamic range photos.
     */
    DJIFlatCameraModePhotoEHDR,
    

    /**
     *  Sets the camera to the high resolution mode. In this mode, the camera will take
     *  photos with a resolution of 48MP. Only supported by Mavic Air 2.
     */
    DJIFlatCameraModePhotoHighResolution,


    /**
     *  Sets the camera to the smart mode. In this mode, when shooting photo, the camera
     *  can automatically recognize the scene, and use the built-in algorithm to
     *  optimize the scene. Only supported by Mavic Air 2, DJI Air 2S.
     */
     ...
     *
     */
    DJIFlatCameraModeSlowMotion,
    

    /**
     *  Internal work mode during smart inspection and it cannot be set manually. This
     *  mode might last for less than 10 seconds, during when the user cannot take
     *  photo, record a video, enter media playback mode, set spot metering target of
     *  `DJILensTypeZoom` lens type, and set zoom focus length with any lens type. Only
     *  `DJICameraFocusModeAuto` can be set with `DJILensTypeZoom` lens type. In this
     *  mode, remote controller also cannot be used to take photo, record video and
     *  adjust focus. It's only supported by Matrice 300 RTK.
     */
    DJIFlatCameraModeInternalAISpotChecking = 0x1B,
    

    /**
     *  The camera work mode is unknown.
     */
    DJIFlatCameraModeUnknown = 0xFF,
};
...
typedef NS_ENUM(NSUInteger, DJILensType) {
    ...
    /**
     *  Infrared Thermal lens.
     */
    DJILensTypeInfraredThermal,
};
...
typedef NS_ENUM (NSUInteger, DJICameraShootPhotoMode){
    ...
    /**
     *  In Camera Panorama mode, which is miss in Previous Version since Mavic 2 Zoom
     *  and Mavic 2 Pro.
     */
    ...
    /**
     *  Indicates that the photo was taken in high resolution mode(48 MP 8000×6000
     *  pixel). Supported by Mavic Air 2.
     */
...
typedef NS_ENUM (NSUInteger, DJICameraVideoResolution){
    ...
    /**
     *  The camera's video resolution is 640x360. Supported by Mavic 2 Enterprise Dual
     *  thermal camera.
     */
    DJICameraVideoResolution640x360,
    ...
    // 8K
    DJICameraVideoResolution7680x4320,
...
typedef NS_ENUM (NSUInteger, DJICameraVideoFrameRate){
    ...
    /**
     *  The camera's video frame rate is 240fps (frames per second). This frame rate can
     *  only be used when `isSlowMotionSupported` returns `YES`.
     */
    DJICameraVideoFrameRate240FPS,
    

    /**
     *  The camera's video frame rate is 8.7fps (frames per second). Supported by Mavic
     *  2 Enterprise Dual thermal camera.
     */
    DJICameraVideoFrameRate8dot7FPS,
...
/**
 *  Video standard values. The default value is NTSC. For Zenmuse H20 Series, please
 *  access the value through class `DJILens`.
 */
...
typedef NS_ENUM (NSUInteger, DJICameraPhotoBurstCount){
    ...
    /**
     *  The camera burst shoot count is set to capture 2 pictures at once when the
     *  camera shoots a photo.
     */
    DJICameraPhotoBurstCount2 = 2,
...
typedef NS_ENUM(NSUInteger, DJICameraPhotoPanoramaMode) {
     ...
     *  resolution photo. It is supported by Spark, Mavic Air, Mavic 2, Mavic 2 Pro,
     *  Mavic 2 Zoom, Mavic 2 Eneterprise, Mavic 2 Enterprise Dual.
     */
...
typedef NS_ENUM (NSUInteger, DJICameraShutterSpeed) {
    ...
    /**
     *  Camera's shutter speed 1/20000 s.
     */
    DJICameraShutterSpeed1_20000 = 0,


    /**
     *  Camera's shutter speed 1/16000 s.
     */
    DJICameraShutterSpeed1_16000 = 1,
    

    /**
     *  Camera's shutter speed 1/12800 s.
     */
    DJICameraShutterSpeed1_12800 = 2,


    /**
     *  Camera's shutter speed 1/10000 s.
     */
    DJICameraShutterSpeed1_10000 = 3,
    

    /**
     *  Camera's shutter speed 1/8000 s.
     */
    DJICameraShutterSpeed1_8000 = 4,
 

    /**
     *  Camera's shutter speed 1/6400 s.
     */
    DJICameraShutterSpeed1_6400 = 5,
 

    /**
     *  Camera's shutter speed 1/6000 s.
     */
    DJICameraShutterSpeed1_6000 = 6,
 

    /**
     *  Camera's shutter speed 1/5000 s.
     */
    DJICameraShutterSpeed1_5000 = 7,
 

    /**
     *  Camera's shutter speed 1/4000 s.
     */
    DJICameraShutterSpeed1_4000 = 8,
 

    /**
     *  Camera's shutter speed 1/3200 s.
     */
    DJICameraShutterSpeed1_3200 = 9,
 

    /**
     *  Camera's shutter speed 1/3000 s.
     */
    DJICameraShutterSpeed1_3000 = 10,
 

    /**
     *  Camera's shutter speed 1/2500 s.
     */
    DJICameraShutterSpeed1_2500 = 11,
 

    /**
     *  Camera's shutter speed 1/2000 s.
     */
    DJICameraShutterSpeed1_2000 = 12,
 

    /**
     *  Camera's shutter speed 1/1500 s.
     */
    DJICameraShutterSpeed1_1500 = 13,
 

    /**
     *  Camera's shutter speed 1/1600 s.
     */
    DJICameraShutterSpeed1_1600 = 14,
 

    /**
     *  Camera's shutter speed 1/1250 s.
     */
    DJICameraShutterSpeed1_1250 = 15,
 

    /**
     *  Camera's shutter speed 1/1000 s.
     */
    DJICameraShutterSpeed1_1000 = 16,
 

    /**
     *  Camera's shutter speed 1/800 s.
     */
    DJICameraShutterSpeed1_800 = 17,
    

    /**
     *  Camera's shutter speed 1/750 s.
     */
    DJICameraShutterSpeed1_750 = 18,
 

    /**
     *  Camera's shutter speed 1/725 s.
     */
    DJICameraShutterSpeed1_725 = 19,
 

    /**
     *  Camera's shutter speed 1/640 s.
     */
    DJICameraShutterSpeed1_640 = 20,
 

    /**
     *  Camera's shutter speed 1/500 s.
     */
    DJICameraShutterSpeed1_500 = 21,
 

    /**
     *  Camera's shutter speed 1/400 s.
     */
    DJICameraShutterSpeed1_400 = 22,
 

    /**
     *  Camera's shutter speed 1/350 s.
     */
    DJICameraShutterSpeed1_350 = 23,
 

    /**
     *  Camera's shutter speed 1/320 s.
     */
    DJICameraShutterSpeed1_320 = 24,
 

    /**
     *  Camera's shutter speed 1/250 s.
     */
    DJICameraShutterSpeed1_250 = 25,
 

    /**
     *  Camera's shutter speed 1/240 s.
     */
    DJICameraShutterSpeed1_240 = 26,
 

    /**
     *  Camera's shutter speed 1/200 s.
     */
    DJICameraShutterSpeed1_200 = 27,
 

    /**
     *  Camera's shutter speed 1/180 s.
     */
    DJICameraShutterSpeed1_180 = 28,
 

    /**
     *  Camera's shutter speed 1/160 s.
     */
    DJICameraShutterSpeed1_160 = 29,
 

    /**
     *  Camera's shutter speed 1/125 s.
     */
    DJICameraShutterSpeed1_125 = 30,
 

    /**
     *  Camera's shutter speed 1/120 s.
     */
    DJICameraShutterSpeed1_120 = 31,
 

    /**
     *  Camera's shutter speed 1/100 s.
     */
    DJICameraShutterSpeed1_100 = 32,
 

    /**
     *  Camera's shutter speed 1/90 s.
     */
    DJICameraShutterSpeed1_90 = 33,
 

    /**
     *  Camera's shutter speed 1/80 s.
     */
    DJICameraShutterSpeed1_80 = 34,
 

    /**
     *  Camera's shutter speed 1/60 s.
     */
    DJICameraShutterSpeed1_60 = 35,
 

    /**
     *  Camera's shutter speed 1/50 s.
     */
    DJICameraShutterSpeed1_50 = 36,
    

    /**
     *  Camera's shutter speed 1/45 s.
     */
    DJICameraShutterSpeed1_45 = 37,
 

    /**
     *  Camera's shutter speed 1/40 s.
     */
    DJICameraShutterSpeed1_40 = 38,
 

    /**
     *  Camera's shutter speed 1/30 s.
     */
    DJICameraShutterSpeed1_30 = 39,
 

    /**
     *  Camera's shutter speed 1/25 s.
     */
    DJICameraShutterSpeed1_25 = 40,
 

    /**
     *  Camera's shutter speed 1/20 s.
     */
    DJICameraShutterSpeed1_20 = 41,
 

    /**
     *  Camera's shutter speed 1/15 s.
     */
    DJICameraShutterSpeed1_15 = 42,
 

    /**
     *  Camera's shutter speed 1/12.5 s.
     */
    DJICameraShutterSpeed1_12Dot5 = 43,
 

    /**
     *  Camera's shutter speed 1/10 s.
     */
    DJICameraShutterSpeed1_10 = 44,
 

    /**
     *  Camera's shutter speed 1/8 s.
     */
    DJICameraShutterSpeed1_8 = 45,
 

    /**
     *  Camera's shutter speed 1/6.25 s.
     */
    DJICameraShutterSpeed1_6Dot25 = 46,
    

    /**
     *  Camera's shutter speed 1/6 s.
     */
    DJICameraShutterSpeed1_6 = 47,
 

    /**
     *  Camera's shutter speed 1/5 s.
     */
    DJICameraShutterSpeed1_5 = 48,
 

    /**
     *  Camera's shutter speed 1/4 s.
     */
    DJICameraShutterSpeed1_4 = 49,
 

    /**
     *  Camera's shutter speed 1/3 s.
     */
    DJICameraShutterSpeed1_3 = 50,
 

    /**
     *  Camera's shutter speed 1/2.5 s.
     */
    DJICameraShutterSpeed1_2Dot5 = 51,
    

    /**
     *  Camera's shutter speed 0.3 s.
     */
    DJICameraShutterSpeed0Dot3 = 52,
 

    /**
     *  Camera's shutter speed 1/2 s.
     */
    DJICameraShutterSpeed1_2 = 53,
 

    /**
     *  Camera's shutter speed 1/1.67 s.
     */
    DJICameraShutterSpeed1_1Dot67 = 54,
 

    /**
     *  Camera's shutter speed 1/1.25 s.
     */
    DJICameraShutterSpeed1_1Dot25 = 55,
 
    /**
     *  Camera's shutter speed Auto.
     */
    DJICameraShutterSpeedAuto = 56,
    

    /**
     *  Camera's shutter speed 0.7 s.
     */
    DJICameraShutterSpeed0Dot7 = 57,
 

    /**
     *  Camera's shutter speed 1.0 s.
     */
    DJICameraShutterSpeed1 = 58,
 

    /**
     *  Camera's shutter speed 1.3 s.
     */
    DJICameraShutterSpeed1Dot3 = 59,
    

    /**
     *  Camera's shutter speed 1.4 s.
     */
    DJICameraShutterSpeed1Dot4 = 60,
 

    /**
     *  Camera's shutter speed 1.6 s.
     */
    DJICameraShutterSpeed1Dot6 = 61,
 

    /**
     *  Camera's shutter speed 2.0 s.
     */
    DJICameraShutterSpeed2 = 62,
 

    /**
     *  Camera's shutter speed 2.5 s.
     */
    DJICameraShutterSpeed2Dot5 = 63,
 

    /**
     *  Camera's shutter speed 3.0 s.
     */
    DJICameraShutterSpeed3 = 64,
 

    /**
     *  Camera's shutter speed 3.2 s.
     */
    DJICameraShutterSpeed3Dot2 = 65,
 

    /**
     *  Camera's shutter speed 4.0 s.
     */
    DJICameraShutterSpeed4 = 66,
 

    /**
     *  Camera's shutter speed 5.0 s.
     */
    DJICameraShutterSpeed5 = 67,
 

    /**
     *  Camera's shutter speed 6.0 s.
     */
    DJICameraShutterSpeed6 = 68,
 

    /**
     *  Camera's shutter speed 7.0 s.
     */
    DJICameraShutterSpeed7 = 69,
 

    /**
     *  Camera's shutter speed 8.0 s.
     */
    DJICameraShutterSpeed8 = 70,
 

    /**
     *  Camera's shutter speed 9.0 s.
     */
    DJICameraShutterSpeed9 = 71,
 

    /**
     *  Camera's shutter speed 10.0 s.
     */
    DJICameraShutterSpeed10 = 72,
    

    /**
     *  Camera's shutter speed 11.0 s.
     */
    DJICameraShutterSpeed11 = 73,
 

    /**
     *  Camera's shutter speed 13.0 s.
     */
    DJICameraShutterSpeed13 = 74,
 

    /**
     *  Camera's shutter speed 15.0 s.
     */
    DJICameraShutterSpeed15 = 75,
    

	/**
	 *  Camera's shutter speed 16.0 s.
	 */
    DJICameraShutterSpeed16 = 76,
 

    /**
     *  Camera's shutter speed 20.0 s.
     */
    DJICameraShutterSpeed20 = 77,
    

    /**
     *  Camera's shutter speed 23.0 s.
     */
    DJICameraShutterSpeed23 = 78,
 

    /**
     *  Camera's shutter speed 25.0 s.
     */
    DJICameraShutterSpeed25 = 79,
 

    /**
     *  Camera's shutter speed 30.0 s.
     */
    DJICameraShutterSpeed30 = 80,
...
/**
 *  Camera aperture values. Zenmuse P1, X5, X5R, Z30, Phantom 4 Pro camera, X4S and
 *  X5S support this setting.
 */
typedef NS_ENUM (NSUInteger, DJICameraAperture) {
    

    /**
     *  The Aperture value is f/1.
     */
    DJICameraApertureF1,
    

    /**
     *  The Aperture value is f/1.2.
     */
    DJICameraApertureF1Dot2,
    

    /**
     *  The Aperture value is f/1.3.
     */
    DJICameraApertureF1Dot3,
    

    /**
     *  The Aperture value is f/1.4.
     */
    DJICameraApertureF1Dot4,
    ...
    /**
     *  The Aperture value is f/25.
     */
    DJICameraApertureF25,
    

    /**
     *  The Aperture value is f/28.
     */
    DJICameraApertureF28 = DJICameraApertureF25+2,
    

    /**
     *  The Aperture value is f/32.
     */
    DJICameraApertureF32,
    

    /**
     *  The Aperture value is f/37.
     */
    DJICameraApertureF37,
    

    /**
     *  The Aperture value is f/41.
     */
    DJICameraApertureF41,
    

    /**
     *  The Aperture value is f/45.
     */
    DJICameraApertureF45,
    

    /**
     *  The Aperture value is f/52.
     */
    DJICameraApertureF52,
    

    /**
     *  The Aperture value is f/58.
     */
    DJICameraApertureF58,
    

    /**
     *  The Aperture value is f/64.
     */
    DJICameraApertureF64,
...
/**
 *  Create a `DJICameraWhiteBalance` instance with white balance preset and
 *  temperature.
 *  
...
typedef NS_ENUM (NSUInteger, DJICameraFocusMode){
     ...
     *  and Mavic 2 Pro camera, DJI Air 2S.
     */
...
typedef NS_ENUM(NSUInteger, DJICameraCalibrateState) {
    ...
    /**
     *  If the camera lenses are not calibrated. Focusing action will be influenced.
     *  Please use calibration interface if you need.
     */
    DJICameraCalibrateState_NotCalibrate = 0,


    /**
     *  Camera lens calibrated. Do not need to calibrate.
     */
    DJICameraCalibrateState_Calibrated = 1,


    /**
     *  Calibration is in progress.
     */
    DJICameraCalibrateState_Calibrating = 2,


    /**
     *  Waiting for the calibration.
     */
    DJICameraCalibrateState_WaitingForCalibrate = 3,


    /**
     *  The camera lens's state is unknown.
     */
    DJICameraCalibrateState_Unknown = 0xFF,
};
...
typedef NS_ENUM(NSUInteger, DJICameraCalibrateResult) {
     ...
     *  No calibration.
     */
    DJICameraCalibrateResult_Idle = 0,


    /**
     *  The calibration is successful.
     */
    DJICameraCalibrateResult_Completed = 1,


    /**
     *  The calibration is failed. Please retry.
     */
    DJICameraCalibrateResult_FailNormal = 2,


    /**
     *  The calibration is failed because of the data error. Please retry.
     */
    DJICameraCalibrateResult_DataError = 3,


    /**
     *  The calibration is failed with the unknown error.
     */
    DJICameraCalibrateResult_Unknown = 0xFF,
};
...
typedef NS_ENUM(NSUInteger, DJICameraThermalPalette) {
	 ...
	 *  Palette type is RedHotIso. Shown as Tint in DJI Pilot.
	 */
	 ...
	 *  the Palette type is GreenHotIso. Shown as Medical in DJI Pilot.
	 */
     ...
     *  the Palette type is RainbowIso.  Shown as Rainbow1 in DJI Pilot.
     */
     ...
     *  the Palette type is IronbowWHIso. Shown as IronRed in DJI Pilot.
     */
     ...
     *  the Palette type is IceFireIso. Shown as Arctic in DJI Pilot.
     */
     ...
     *  Palette type is MidRangeWHIso. Shown as Fulgurite in DJI Pilot.
     */
     ...
     *  Palette type is MidRangeBHIso. Shown as HotIron in DJI Pilot.
     */
     ...
     *  Palette type is RainbowHCIso. Shown as Rainbow2 in DJI Pilot.
     */
    DJICameraThermalPaletteRain,
    

    /**
     *  Without Isotherm enabled, the Palette type is HotSpot. With Isotherm enabled,
     *  the Palette type is HotSpotIso. Only supported by Mavic 2 Enterprise Dual.
     */
    DJICameraThermalPaletteHotSpot,
    

    /**
     *  Without Isotherm enabled, the Palette type is Rainbow2. With Isotherm enabled,
     *  the Palette type is Rainbow2Iso. Only supported by Mavic 2 Enterprise Dual.
     */
    DJICameraThermalPaletteRainbow2,
    

    /**
     *  Without Isotherm enabled, the Palette type is Gray. With Isotherm enabled, the
     *  Palette type is GrayIso. Only supported by Mavic 2 Enterprise Dual.
     */
    DJICameraThermalPaletteGray,
    

    /**
     *  Without Isotherm enabled, the Palette type is HotMetal. With Isotherm enabled,
     *  the Palette type is HotMetalIso. Only supported by Mavic 2 Enterprise Dual.
     */
    DJICameraThermalPaletteHotMetal,
    

    /**
     *  Without Isotherm enabled, the Palette type is ColdSpot. With Isotherm enabled,
     *  the Palette type is ColdSpotIso. Only supported by Mavic 2 Enterprise Dual.
     */
...
/**
 *  The unit for Isotherm. For Zenmuse H20T and H20N, please access the value
 *  through class `DJILens`.
 */
...
typedef NS_ENUM(NSUInteger, DJICameraThermalResolution) {
    ...
    /**
     *  The thermal imaging camera resolution is 384x288.
     */
    DJICameraThermalResolution384x288,
    

    /**
     *  The thermal imaging camera resolution is 1024x768.
     */
    DJICameraThermalResolution1024x768,
...
typedef NS_ENUM(NSUInteger, DJICameraThermalDigitalZoomFactor) {
    ...
    /**
     *  Digital Zoom factor is x8. Not support by Mavic 2 Enterprise Dual Light Camera.
     */
    DJICameraThermalDigitalZoomFactorx8,
    

    /**
     *  Digital Zoom factor is x16. Not support by Mavic 2 Enterprise Dual Light Camera.
     */
    DJICameraThermalDigitalZoomFactorx16,
    

    /**
     *  Digital Zoom factor is x32. Not support by Mavic 2 Enterprise Dual Light Camera.
     */
    DJICameraThermalDigitalZoomFactorx32,
 ...
 *  thermal camera. Only supported by XT2 camera and and Mavic 2 Enterprise Dual
 *  Camera.
 */
typedef NS_ENUM(NSUInteger, DJICameraDisplayMode) {
     ...
     *  `DJICameraPIPPosition`. Not supported by Mavic 2 Enterprise Dual.
     */
 ...
 *  display mode is `DJICameraDisplayModePIP`. Only supported by XT2 camera and
 *  Mavic 2 Enterprise Dual Light Camera.
 */
...
/*********************************************************************************/
#pragma mark DJICameraHybridZoomSpec
/*********************************************************************************/


/**
 *  Hybrid zoom lens profile. Includes focal length range and maximum optical focal
 *  length and minimum focal length step. Supported by Mavic 2 Zoom Camera and Mavic
 *  2 Enterprise Camera.
 */
typedef struct {
...
/*********************************************************************************/
#pragma mark - DJICameraTapZoomState
/*********************************************************************************/


/**
 *  The state of the tap zoom action. Only supported by Z30 camera. For Zenmuse H20
 *  Series and Mavic 2 Enterprise Advanced, please access the value through class
 *  `DJILens`.
 */
typedef NS_ENUM(uint8_t, DJICameraTapZoomState) {
    ...
    /**
     *  The tap zoom is not triggered yet. It will always push
     *  `DJICameraTapZoomStateIdle` if camera is not zooming.
     */
    DJICameraTapZoomStateIdle,
    

    /**
     *  The camera is zooming in. The focal length increases, field of view becomes
    ...
    /**
     *  The camera is zooming in the focal length decreases, field of view becomes wider
     *  and magnification is lower.
     */
    DJICameraTapZoomStateZoomOut,
    

    /**
     *  It means the camera has reached its maximum focus length. It will always push
     *  `DJICameraTapZoomStateZoomLimited` if the camera reaches its maximum focus
     *  length.
     */
...
typedef NS_ENUM(NSUInteger, DJICameraPictureStylePresetType) {
     ...
     *  Unknown preset type
     */
    DJICameraPictureStylePresetTypeUnknown = 0xFF,
...
typedef NS_ENUM(NSUInteger, DJICameraTemperatureUnit) {
	 ...
	 *  Unknown.
	 */
	DJICameraTemperatureUnitUnknown = 0xFF,
};
...
/**
 *  Display modes to coordinate the video feeds from both the RGB sensor and single-
 *  band sensors. Only supported by multispectral camera of P4 Multispectral.
 */
typedef NS_ENUM (NSUInteger, DJICameraMultispectralDisplayMode){
    ...
    /**
     *  Displays the NVDI (normalized difference vegetation index) frames as video feed
     *  produced by the multispectral camera.
     */
     ...
     */
    DJICameraMultispectralDisplayModeUnknown = 0xFF,
};


/**
 *  Enums represent the spectrum bands of a multispectral camera. For P4
 *  Multispectral, the camera supports 5 bands. Only supported by multispectral
...
typedef NS_ENUM(NSInteger, DJICameraSpectrumBand){
     ...
     *  The blue spectrum.
     */
    DJICameraSpectrumBandBlue,
    

    /**
     *  The green spectrum.
     */
    DJICameraSpectrumBandGreen,
    

    /**
     *  The red spectrum.
     */
    DJICameraSpectrumBandRed,
    

    /**
     *  The near infrared spectrum.
     */
    DJICameraSpectrumBandNearInfrared,
    

    /**
     *  The near infrared spectrum.
     */
    DJICameraSpectrumBandRedEdge,
    

    /**
     *  Unknown.
     */
    DJICameraSpectrumBandUnknown = 0xFF,
};

/*********************************************************************************/
#pragma mark DJICameraMultispectralStorageSettings
/*********************************************************************************/

/**
 *  The settings for storing photos produced by a multispectral camera. Use the
 *  mutable class if modification of the settings is required. Only supported by
...
/**
 *  The mutable settings for storing photos produced by a multispectral camera. Only
...
/*********************************************************************************/
#pragma mark - DJICameraMultispectralExposureState
/*********************************************************************************/


/**
 *  The exposure state of a single-band sensor on the multispectral camera. The
 *  parameters in the state determines the relationship between exposure and sensor
 *  data values. When the camera is in different exposure modes, parameters may be
 *  changed by the camera automatically to optimize the exposure.
 */
...
/**
 *  The exposure states of the single-band sensors on the multispectral camera.
 */
@interface DJICameraMultispectralExposureStates : NSObject


/**
 *  The exposure state for all single-band sensors (sensors except the RGB one).
 */
@property (nonatomic, readonly) NSArray <DJICameraMultispectralExposureState *>* sensorsExposureStates;

@end

/*********************************************************************************/
#pragma mark DJICameraVideoStreamSource
/*********************************************************************************/


/**
 *  The enumeration represents which lens the camera stream comes from. The camera
 *  video stream will been used to transfer to image transmission to display and
 *  determine which lens were taken photo or recording. It is only supported by
 *  Zenmuse H20 Series Camera.
 */
typedef NS_ENUM (NSUInteger, DJICameraVideoStreamSource){
    ...
    /**
     *  Wide stream. Only supported by Zenmuse H20 Series and Mavic 2 Enterprise
     *  Advanced.
     */
    ...
    /**
     *  Zoom stream. Only supported by Zenmuse H20 Series and Mavic 2 Enterprise
     *  Advanced.
     */
    ...
    /**
     *  Infrared thermal stream. Only supported by Zenmuse H20T and H20N.and Mavic 2
     *  Enterprise Advanced.
     */
     ...
     *  Unknown.
     */
    DJICameraVideoStreamSourceUnknown = 0xFF,
};


/**
 *  The class is used to save laser sensor information which includes the laser
 *  sensor switch status, the target object information and laser state. The laser
 *  sensor must be at least 3m from the target point. Only supported by Zenmuse H20
 *  Series.
 */
...
/**
 *  Gets the relative target point base the lens origin point which measures by the
 *  laser sensor. The range for x and y is from 0 to 1000. The point [0, 0]
...
/**
 *  The class is used to describe current state of infrared thermal camera.
 *  Only supported by Zenmuse H20T.
 */
@interface DJICameraInfraredSensorState : NSObject

/**
 *  ``YES`` if the infrared sensor burning protection is enabled.
 */
@property (nonatomic, readonly) BOOL isInfraredSensorBurningProtectionEnabled;

/**
 *  ``YES`` if the infrared thermal camera shutter is enabled.
 */
@property (nonatomic, readonly) BOOL isInfraredThermalCameraShutterEnabled;

@end


/**
 *  The class is used to save camera video stream settings during taking photo or
 *  recording video.`needCurrentLiveViewStream` is used to determine whether if
 *  current live view stream(set by `setCameraVideoStreamSource:withCompletion`)
 *  will be captured or recorded when taking photo or recording video. `streams` is
 *  used to determine which camera stream source will be captured or recorded. Only
 *  supported by Zenmuse H20 Series Camera.
 */
@interface DJICameraStreamSettings : NSObject


/**
 *  Determines whether if current live view stream need to been captured or recorded
 *  when taking photo or recording video.
 *  
 *  @return `YES` if needed to save current liveview stream.
 */
@property (nonatomic, readonly) BOOL needCurrentLiveViewStream;


/**
 *  Determines which camera video stream source will been captured or recorded when
 *  taking photo or recording video. The camera video stream source came from
 *  `DJICameraVideoStreamSource`.
 *  
 *  @return A List of `DJICameraVideoStreamSource`.
 */
 ...
 *  
 *  @param isCurrentLiveviewNeeded `YES` if needed to save current liveview stream.
 *  @param streams A List of `DJICameraVideoStreamSource`.
 */
