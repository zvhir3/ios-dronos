 ...
 *  supported by the aircraft. The accessory aggregation component is available when
 *  Mavic 2 Enterprise is connected. An accessory becomes available only when the
 *  accessory is connected to the aircraft.
 */
